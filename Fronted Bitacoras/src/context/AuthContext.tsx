...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const [id_usuario, setIdUsuario] = useState<number | null>(null); // Valor predeterminado

  const [id_rol_per, setIdRolPer] = useState<number | null>(null); // Valor predeterminado
  ...
  return (
    <AuthContext.Provider value={{ id_rol_per, setIdRolPer, id_usuario, setIdUsuario }}>
      {children}
